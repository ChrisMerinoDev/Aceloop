  ...
  return (
    <header className="sticky top-0 z-40 bg-panel border-b-4 border-border-px">
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-4">
        ...
        <nav className="hidden md:flex items-center gap-1 text-2xl">
          {LINKS.map((l) => (
            <Link
              key={l.href}
              href={l.href}
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center text-ink-dim hover:text-gold-2"
          ...
          >
            <svg
              ...
              className="shrink-0"
            >
              <path d="M13.63 0H2.37A2.36 2.36 0 000 2.37v11.26A2.36 2.36 0 002.37 16h11.26A2.36 2.36 0 0016 13.63V2.37A2.36 2.36 0 0013.63 0zM4.9 13.4H2.65V6.16H4.9zM3.77 5.16a1.31 1.31 0 110-2.62 1.31 1.31 0 010 2.62zm9.63 8.24h-2.25V9.88c0-.88-.02-2-1.22-2-1.22 0-1.41.96-1.41 1.94v3.58H6.28V6.16h2.16v.99h.03c.3-.57 1.04-1.17 2.13-1.17 2.28 0 2.7 1.5 2.7 3.45z" />
            </svg>
          </a>
          <button
